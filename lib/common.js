...
exports.common = function() {
    ...
    obj._stats_pp = function(data) {
                        var copy = data || '';
                        // replace any characters that are invalid statsd output with
                        // an _. Then, replace multiple _ with a single one.
                        copy = copy.replace( /[^\w-.]/g, "_" );
